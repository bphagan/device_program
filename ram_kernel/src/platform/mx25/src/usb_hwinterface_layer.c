...
Prabhat singh                        31-Aug-2007     TLSbo95960 changed mask value from 0x3f to 0x7f 
prabhat Singh                 27/07/2007     TLSbo94950  Ported to Ringo
SaiKiran Bollu               07/24/2007     TLSb094949    Removed SFS workaround in ipl_receive_setup_data and merged fix TLSbo94169 
...
Bharat Bhushan               29/12/2006     TLSbo87034   Access to memories from titanium is in BE32 mode.
Bharat Bhushan               25/09/2006     TLSbo78968   New Serial Boot strategy implementation.
...
extern void usb_ulpi_interface_enable(void);
extern void usb_utmi_interface_enable(void);
...
ipl_is_interface_high_speed(void)
{
    ...
    while(!((*(VP_U32)USB_OTG_USBSTS) & USB_OTG_PORT_OPERATIONAL ));
#endif
