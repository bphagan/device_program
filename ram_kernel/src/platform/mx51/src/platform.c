...
static void __sys_mmu_init(void)
{
	...
	*/
	...
	MMU_SECTION(0x000, 0x000,   0x1FF, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
		     
	MMU_SECTION(0x200, 0x200,   0x1,
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
		    
	MMU_SECTION(0x1FF, 0x1FF,   0x001, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
		    
	MMU_SECTION(0x300, 0x300,   0x100, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
		    
	MMU_SECTION(0x400, 0x400,   0x200, 
	            ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
	            
	MMU_SECTION(0x600, 0x600,   0x300, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
	
	/* SDRAM */	    
	MMU_SECTION(0x900, 0x900,   0x200, 
		    ARM_CACHEABLE,   ARM_BUFFERABLE,   ARM_ACCESS_PERM_RW_RW);
		    
	MMU_SECTION(0x900, 0xE00,   0x200, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW); 
		    
	MMU_SECTION(0xB80, 0xB80,   0x10,  
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
		    
	MMU_SECTION(0xCC0, 0xCC0,   0x040, 
		    ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW);
...
#if 0
	/* NAND clock podf */
	__REG32(0x73fd4014) = 0x597B5147;
	
	/* PLL1 */
	__REG32(0x83fd400c) = 0x4;
	__REG32(0x83f80000) = 0x1232;
	__REG32(0x83f80004) = 0x2;
	__REG32(0x83f80008) = ((8 << 4) + ((1 - 1)  << 0));
	__REG32(0x83f8000C) = (3 - 1);
	__REG32(0x83f80010) = 1;
	__REG32(0x83f80000) = 0x1232;
	while((__REG32(0x83f80000) & 1 ) != 1);
	__REG32(0x83fd400c) = 0x0;
#endif
}
