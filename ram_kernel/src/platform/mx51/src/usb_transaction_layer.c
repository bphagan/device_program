...
Siva Pothireddy                01/Dec/2007   engcm02041   Changed String Descriptor and included endianess check for simulator
Mahima Verma                 26/Sep/2007    ENGcm00387   Watch dog is not serviced properly when
                                                         Enumerate test is being executed.
...
/*==================================================================================================
                                     LOCAL CONSTANTS
==================================================================================================*/
#define IIM_BASE_ADDR               0x83F98000
#define IIM_FB0_BASE                (IIM_BASE_ADDR + 0x0800)
#define IIM_SCS0_REG                (IIM_BASE_ADDR + 0x2c )
#define IIM_SCS1_REG                (IIM_BASE_ADDR + 0x30 )
#define IIM_SCS2_REG                (IIM_BASE_ADDR + 0x34 )
#define IIM_SCS3_REG                (IIM_BASE_ADDR + 0x38 )
/*IIM register masks*/
#define IIM_SCS1_LPB_MASK           0x01



#define HAPI_IIM_SCS1_LPB_READ_STATUS() ((*(VP_U32)IIM_SCS1_REG) &  IIM_SCS1_LPB_MASK)   
...
static usb_config_desc_t g_usb_config_desc_hs_ns =
{
    USB_DEV_CONFIG_DESC_LEN,
    USB_DEV_CONFIG_DESC_TYPE,
    USB_DEV_CONFIG_DESC_TTL_LEN_LB ,
...
/* High Speed Secure */
static usb_config_desc_t g_usb_config_desc_hs_s =
{
    USB_DEV_CONFIG_DESC_LEN,
    USB_DEV_CONFIG_DESC_TYPE,
    USB_DEV_CONFIG_DESC_TTL_LEN_LB ,
...
tl_init(void)
{
    ...
    /* Get hab_su_type */
    U8 u8Type = (U8)((*((volatile U8 *)(IIM_FB0_BASE + 0x10))) & 0x7);
    ...
    if(HAPI_IIM_SCS1_LPB_READ_STATUS())/*If LPB Enabled*/
    {
        g_usb_desc.config_desc->attributes = (UINT8)USB_DEV_CONFIG_DESC_LPB_ATTRIBUTES;
        g_usb_desc.config_desc->max_power = (UINT8)USB_DEV_CONFIG_DESC_LPB_MAX_POWER;
...
==================================================================================================*/
static void tl_handle_get_config_desc(U8 other_speed)
{
    usb_buffer_descriptor_t bd;
    U32 buffer_addrs;
