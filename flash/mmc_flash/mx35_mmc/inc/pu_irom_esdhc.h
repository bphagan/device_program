...
#if defined (REV_TO1)
#define ESDHC_SYSCTL_IDENT_FREQ   ((UINT32)0x0000800e)  /* SDCLKFS 0x08 ; DVS 0xe */
#define ESDHC_SYSCTL_OPERT_FREQ   ((UINT32)0x00000200)  /* SDCLKFS 0x02 ; DVS 0x0 */               
#elif defined (REV_TO2)
#define ESDHC_SYSCTL_IDENT_FREQ   ((UINT32)0x00002040)  /* SDCLKFS 0x20 (64); DVS 0x4 (Divide by 5) */
#define ESDHC_SYSCTL_OPERT_FREQ   ((UINT32)0x00000050)  /* SDCLKFS 0x00 (divide by 1); DVS 0x5(divide by 6) */
#endif
...
#define ESDHC_OPER_TIMEOUT (96 * 100) /* 3 * 3 msec time out */ 
...
extern void interface_init(UINT32 base_address);
