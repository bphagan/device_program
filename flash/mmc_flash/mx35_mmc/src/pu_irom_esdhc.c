...
{
    (UINT32 *) ((UINT32) IOMUXC_BASE_ADDR + 0x0004),
    (UINT32 *) ((UINT32) IOMUXC_BASE_ADDR + 0x0328),
#if defined (REV_TO1)
    (UINT32 *) ((UINT32) IOMUXC_BASE_ADDR + 0x07AC)
#elif defined (REV_TO2)
    (UINT32 *) ((UINT32) IOMUXC_BASE_ADDR + 0x07A8)
#endif
};
...
#define esdhc_3_regs_base_address       (0x53fbc000)
...
UINT32 interface_data_read (UINT32 *dest_ptr,UINT32 blk_len)
{
    ...
    for(i = ZERO; i < block_count; i++)
    {
...
#ifdef TY_DBG
		{
			// Terry adds for debug, :-)
			U8 au8StrBuf[100] = { 0 };
			sprintf(au8StrBuf, "Ty, esdhc_wait_buf_rdy_intr: %d\n", status);
			atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
		}
#endif
        ...
        else
        {
#ifdef TY_DBG
			{
				// Terry adds for debug, :-)
				U8 au8StrBuf[100] = { 0 };
				sprintf(au8StrBuf, "Ty, esdhc_wait_buf_rdy_intr failed!");
				atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
			}
#endif
            break;
    ...
    else
	{
		// Terry adds for debug, :-)
		U8 au8StrBuf[100] = { 0 };
		sprintf(au8StrBuf, "Ty, esdhc_check_data failed!");
		atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	}
#endif
...
static UINT32 esdhc_wait_buf_rdy_intr(UINT32 mask, multi_single_block_select multi_single_block)
{
...
UINT32 interface_data_write (UINT32 *dest_ptr,UINT32 blk_len)
{
   ...
   esdhc_base_pointer->interrupt_status_enable |= ESDHC_INTERRUPT_ENABLE;
    ...
    for(i = 0; i < (blk_len)/FOUR; i++)
    {
        ...
        esdhc_wait_buf_rdy_intr(ESDHC_STATUS_BUF_WRITE_RDY_MSK, SINGLE);
...
IMPORTANT NOTES:
    None
=============================================================================*/
#define HAPI_BT_SDMMC_SRC        ((UINT8)0xC0)
#define HAPI_BT_SDMMC_SRC_SHIFT  ((UINT8)6)
#define hapi_boot_options2_reg   (0x53ff080c)
...
static void esdhc_iomux_configuration(void)
{
...
#ifdef TY_DBG
	{
		// Terry adds for debug, :-)
		U8 au8StrBuf[100] = { 0 };
		sprintf(au8StrBuf, "Ty, Entry: esdhc_iomux_configuration\n");
		atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	}
#endif

    //interface_esdhc = HAPI_IC_ID_BT_SDMMC_SRC_READ();
    interface_esdhc = ((*(VP_U8)(hapi_boot_options2_reg)) & HAPI_BT_SDMMC_SRC) >> HAPI_BT_SDMMC_SRC_SHIFT;
    ...
    switch (interface_esdhc)
    {
...
#ifdef TY_DBG
	    {
		    // Terry adds for debug, :-)
		    U8 au8StrBuf[100] = { 0 };
		    sprintf(au8StrBuf, "Ty, TO1 ESDHC1");
		    atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	    }
#endif
            esdhc_base_pointer = (pESDHC_t)esdhc_1_regs_base_address;

            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_SD1_DATA3_REG, HAPI_SD1_DATA3_PAD_VALUE);
            break;
        case ESDHC2:
 #ifdef TY_DBG
	    {
		    // Terry adds for debug, :-)
		    U8 au8StrBuf[100] = { 0 };
		    sprintf(au8StrBuf, "Ty, ESDHC2");
		    atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	    }
#endif
            esdhc_base_pointer = (pESDHC_t)esdhc_2_regs_base_address;

            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_SD2_DATA3_REG, HAPI_SD2_DATA3_PAD_VALUE);
            break;
        case ESDHC3:
#ifdef TY_DBG
	    {
            ...
            HAPI_GPIO_config(HAPI_IOMUX_ATA_DIOR_PORT,HAPI_IOMUX_ATA_DIOR_PIN,
                            HAPI_IOMUX_ATA_DIOR_SEL,HAPI_IOMUX_ATA_DIOR_DIR);
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,
                    HAPI_IOMUXC_ESDHC3_IPP_DAT0_IN_SELECT_INPUT_REG, 
                    HAPI_ESDHC3_IPP_DAT0_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DIOR_REG, HAPI_ATA_DIOR_PAD_VALUE );
            HAPI_GPIO_config(HAPI_IOMUX_ATA_DIOW_PORT,HAPI_IOMUX_ATA_DIOW_PIN,
                         HAPI_IOMUX_ATA_DIOW_SEL,HAPI_IOMUX_ATA_DIOW_DIR); 
	        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,HAPI_IOMUXC_ESDHC3_IPP_DAT1_IN_SELECT_INPUT_REG, HAPI_ESDHC3_IPP_DAT1_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DIOW_REG  , HAPI_ATA_DIOW_PAD_VALUE );


            HAPI_GPIO_config(HAPI_IOMUX_ATA_DMACK_PORT,HAPI_IOMUX_ATA_DMACK_PIN,
                         HAPI_IOMUX_ATA_DMACK_SEL,HAPI_IOMUX_ATA_DMACK_DIR);
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,HAPI_IOMUXC_ESDHC3_IPP_DAT2_IN_SELECT_INPUT_REG, HAPI_ESDHC3_IPP_DAT2_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DMACK_REG  , HAPI_ATA_DMACK_PAD_VALUE );


            HAPI_GPIO_config(HAPI_IOMUX_ATA_RESET_B_PORT,HAPI_IOMUX_ATA_RESET_B_PIN, 
                         HAPI_IOMUX_ATA_RESET_B_SEL,HAPI_IOMUX_ATA_RESET_B_DIR);
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,HAPI_IOMUXC_ESDHC3_IPP_DAT3_IN_SELECT_INPUT_REG, HAPI_ESDHC3_IPP_DAT3_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_RESET_B_REG  , HAPI_ATA_RESET_B_PAD_VALUE );

            HAPI_GPIO_config(HAPI_IOMUX_ATA_IORDY_PORT,HAPI_IOMUX_ATA_IORDY_PIN, 
                         HAPI_IOMUX_ATA_IORDY_SEL,HAPI_IOMUX_ATA_IORDY_DIR);
		    HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_IORDY_REG  , HAPI_ATA_DATA1_PAD_VALUE );

            HAPI_GPIO_config(HAPI_IOMUX_ATA_DATA0_PORT,HAPI_IOMUX_ATA_DATA0_PIN, 
                         HAPI_IOMUX_ATA_DATA0_SEL,HAPI_IOMUX_ATA_DATA0_DIR);
		    HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA0_REG  , HAPI_ATA_DATA0_PAD_VALUE );

            HAPI_GPIO_config(HAPI_IOMUX_ATA_DATA1_PORT,HAPI_IOMUX_ATA_DATA1_PIN,  
                         HAPI_IOMUX_ATA_DATA1_SEL,HAPI_IOMUX_ATA_DATA1_DIR);
		    HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA1_REG  , HAPI_ATA_DATA1_PAD_VALUE );
       

            HAPI_GPIO_config(HAPI_IOMUX_ATA_DATA2_PORT,HAPI_IOMUX_ATA_DATA2_PIN,  
                         HAPI_IOMUX_ATA_DATA2_SEL,HAPI_IOMUX_ATA_DATA2_DIR);
		    HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA2_REG  , HAPI_ATA_DATA2_PAD_VALUE );

            HAPI_GPIO_config(HAPI_IOMUX_ATA_DATA3_PORT,HAPI_IOMUX_ATA_DATA3_PIN,  
                         HAPI_IOMUX_ATA_DATA3_SEL,HAPI_IOMUX_ATA_DATA3_DIR);
	        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,HAPI_IOMUXC_ESDHC3_IPP_CARD_CLK_IN_SELECT_INPUT_REG, HAPI_ESDHC3_IPP_CARD_CLK_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA3_REG  , HAPI_ATA_DATA3_PAD_VALUE );

            HAPI_GPIO_config(HAPI_IOMUX_ATA_DATA4_PORT,HAPI_IOMUX_ATA_DATA4_PIN,  
                         HAPI_IOMUX_ATA_DATA4_SEL,HAPI_IOMUX_ATA_DATA4_DIR);  
	        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,HAPI_IOMUXC_ESDHC3_IPP_CMD_IN_SELECT_INPUT_REG, HAPI_ESDHC3_IPP_CMD_IN_SELECT_INPUT_VAL );
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2, HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA4_REG, HAPI_ATA_DATA4_PAD_VALUE );
            break;
        default:
            break;
    }
    ...
    if(interface_esdhc == ESDHC1)
    {
#ifdef TY_DBG
	    {
		    // Terry adds for debug, :-)
		    U8 au8StrBuf[100] = { 0 };
		    sprintf(au8StrBuf, "Ty, TO2 ESDHC1");
		    atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	    }
#endif
    ...
    else if(interface_esdhc == ESDHC2)
    {
        esdhc_base_pointer = (pESDHC_t)esdhc_2_regs_base_address;
    ...
    else if(interface_esdhc == ESDHC3)
    {
        ...
        /* CMD */
        HAPI_GPIO_config(HAPI_IOMUX_ESDHC3_SD3_CMD_PORT,
                         HAPI_IOMUX_ESDHC3_SD3_CMD_PIN,
                         HAPI_IOMUX_ESDHC3_SD3_CMD_SEL,
                         HAPI_IOMUX_ESDHC3_SD3_CMD_DIR);

        /* Daisy Chain */
        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,
                             IOMUXC_ESDHC3_IPP_CMD_IN_SELECT_INPUT_ADDR,
                             IOMUXC_ESDHC3_IPP_CMD_IN_SELECT_INPUT_VAL);

        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA4_ADDR,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA4_VAL);

        /* CLK */
        HAPI_GPIO_config(HAPI_IOMUX_ESDHC3_SD3_CLK_PORT,
                         HAPI_IOMUX_ESDHC3_SD3_CLK_PIN,
                         HAPI_IOMUX_ESDHC3_SD3_CLK_SEL,
                         HAPI_IOMUX_ESDHC3_SD3_CLK_DIR);

        /* Daisy Chain */
        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU3,
                             IOMUXC_ESDHC3_IPP_CLK_IN_SELECT_INPUT_ADDR,
                             IOMUXC_ESDHC3_IPP_CLK_IN_SELECT_INPUT_VAL);

        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA3_ADDR,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA3_VAL);

        /* DATA0 */
        HAPI_GPIO_config(HAPI_IOMUX_ESDHC3_SD3_DATA0_PORT,
                         HAPI_IOMUX_ESDHC3_SD3_DATA0_PIN,
                         HAPI_IOMUX_ESDHC3_SD3_DATA0_SEL,
                         HAPI_IOMUX_ESDHC3_SD3_DATA0_DIR);
        ...
        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DIOR_ADDR,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DIOR_VAL);

        /* DATA3 */
        HAPI_GPIO_config(HAPI_IOMUX_ESDHC3_SD3_DATA3_PORT,
                         HAPI_IOMUX_ESDHC3_SD3_DATA3_PIN,
                         HAPI_IOMUX_ESDHC3_SD3_DATA3_SEL,
                         HAPI_IOMUX_ESDHC3_SD3_DATA3_DIR);
        ...
        HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_RESET_B_ADDR,
                             HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_RESET_B_VAL);
...
#ifdef TY_DBG
	{
		// Terry adds for debug, :-)
		U8 au8StrBuf[100] = { 0 };
		sprintf(au8StrBuf, "Ty, Exit: esdhc_iomux_configuration\n");
		atk_channel_send(au8StrBuf, sizeof(au8StrBuf));
	}
#endif
}
...
void esdhc_set_cmd_pullup(esdhc_pullup_t pull_up)
{
    ...
    if(pull_up == STRONG)
    {
        ...
        else if(interface_esdhc == ESDHC3)
        {
            ...
            HAPI_GPIO_pad_config(HAPI_GPIO_PORT_MCU2,
                                 HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA4_ADDR,
                                 HAPI_IOMUXC_SW_PAD_CTL_PAD_ATA_DATA4_SVAL);
        }
    }
