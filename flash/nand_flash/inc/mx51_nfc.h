...
#define AXI_BASE_ADDR 	0xCFFF0000
#define NFC_BASE_ADDR 	0x83FDB000 
...
void set_fms(u8 bus_width, u32 page_size,u16 oob_size)
{
	...
	raw_write(raw_read(NFC_CONFIGURATION3) & ~0x3, 
	NFC_CONFIGURATION3);
	
	raw_write(raw_read(NFC_CONFIGURATION3) | 0x1, 
	NFC_CONFIGURATION3);
	...
	raw_write(raw_read(NFC_CONFIGURATION3) & (~(7 << 12)), 
	NFC_CONFIGURATION3);
	
	raw_write(raw_read(NFC_CONFIGURATION3) | ((i - 1) << 12), 
	NFC_CONFIGURATION3);
}
